...
TaskStatus = Literal["pending", "running", "completed", "failed", "waiting", "skipped", "emitted"]
...
class Task(BaseModel):
    ...
    This represents the PLAN, not execution state
    
    This is the COMPLETE task definition that both server and client need!
    """
...
class TaskRecord(BaseModel):
    ...
    ✅ STORES THE FULL TASK - Client/Server both get complete context!
    """
    # The original immutable task (FULL DATA)
    ...
    # Client tracking (for client tasks)
